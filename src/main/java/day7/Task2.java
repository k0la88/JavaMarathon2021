...
info() -  выводит сообщение в зависимости от количества игроков на поле. Если игроков меньше 6, то выводит сообщение: “Команды неполные.
На поле еще есть ... свободных мест”, иначе: “На поле нет свободных мест”. Грамматикой русского языка пренебречь,
...
public class Task2 {
    public static void main(String[] args) {
        ...
        Player.info();
        Player player1 = new Player(num.nextInt(11) + 90);
        Player player2 = new Player(num.nextInt(11) + 90);
        Player player3 = new Player(num.nextInt(11) + 90);
        Player.info();
        Player player4 = new Player(num.nextInt(11) + 90);
        Player player5 = new Player(num.nextInt(11) + 90);
        Player player6 = new Player(num.nextInt(11) + 90);
        Player player7 = new Player(num.nextInt(11) + 90);
        Player.info();

        Player.run(player1, "бежать один раз");
        Player.info();
        ...
        /*
        Я честно говоря не совсем понял задание, пробовал по разному. Тесты ни проходили ни как.
        В чем дело, я разобраться не смог.
        Поэтому взял на себя смелось сделать так как понимаю и вижу.
        Завтра придет видео ответ посмотрю что не так.
